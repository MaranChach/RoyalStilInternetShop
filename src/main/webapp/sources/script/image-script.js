...
if (typeof postimage.ready === "undefined") {
    ...
    postimage.opt.skip = postimage.opt.skip || "recaptcha|username_list|search|recipients|coppa|board_email_sig|pf_phpbb_occupation|pf_phpbb_interests|reason|desc|filecomment|comment_list|username|users|text|warning|bbcode|^ban$|^add$|^answers$|occupation|lang|template|interests|^ips$|forum_rules|^body$|^entry$|contact_admin_info";
